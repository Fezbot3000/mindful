...
export const metadata: Metadata = {
  ...
  description: "Analyze your mental health patterns with AI-powered insights. View trends, export data, and discover patterns in your mood tracking and journaling data.",
  keywords: ["mental health analytics", "mood patterns", "wellness insights", "AI analysis", "health data visualization", "therapy insights"],
  openGraph: {
    title: "Insights & Analytics - Mindful Track | Mental Health Analytics",
    description: "Analyze your mental health patterns with AI-powered insights. View trends, export data, and discover patterns in your mood tracking and journaling data.",
