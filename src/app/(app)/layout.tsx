      ...
      <LogsProvider>
        <SidebarProvider>
          <div className="group md:flex">
            ...
            <div className="flex-1 transition-[margin-left] ease-in-out duration-300 md:ml-[3.5rem] group-data-[state=expanded]:md:ml-[16rem] md:max-w-[calc(100vw-3.5rem)] group-data-[state=expanded]:md:max-w-[calc(100vw-16rem)] overflow-x-hidden min-h-screen">
              <div className="flex-1 max-w-full overflow-x-hidden flex flex-col min-h-0">
                ...
                <main className="flex-1 overflow-x-hidden px-4 py-6 sm:px-6 sm:py-6 md:gap-8 pb-40 md:pb-8 max-w-full flex flex-col" role="main" id="main-content">
                  {children}
                </main>
              </div>
            </div>
